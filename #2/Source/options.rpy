...
init -1 python hide:
    ...
    config.window_title = u"ライブコーディング"
    ...
    style.default.font = "tl/None/misaki_gothic.ttf"
    style._default.font = "tl/None/misaki_gothic.ttf"
    ...
    config.main_menu_music = "18loop.ogg"
...
python early:
    config.save_directory = "630-1467282073"
